...
namespace Stutooroo.Migrations
{
    ...
    [Migration("20240516073609_ApplicationUser-PhoneNo-Added-CommentImage-Removed")]
    partial class ApplicationUserPhoneNoAddedCommentImageRemoved
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stutooroo.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Stutooroo.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Stutooroo.Models.FavoriteListing", b =>
                {
                    ...
                    b.HasOne("Stutooroo.Models.ApplicationUser", "FavoritedByUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
