...
namespace Stutooroo.Migrations
{
    ...
    [Migration("20240402102544_ListingNullablePropertiesv2")]
    partial class ListingNullablePropertiesv2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Stutooroo.Models.FavoriteListing", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "FavoritedByUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
